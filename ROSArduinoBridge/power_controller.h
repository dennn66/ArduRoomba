...
void pc_spin(int *batVoltage, int *batCurrent, int *batRemain){
  if (millis() > nextVoltageTimer) {
    ...
    *batCurrent=rightMotorCurrentRAW;//(int)((float)(batCurrentRAW));//*ADC2CURRENT);
    Serial.print(nextVoltageTimer);Serial.print(" ");
    Serial.print("BATVOLTAGE ");Serial.print(*batVoltage);Serial.print(" ");
    Serial.print("BATCHARGECURRENT ");Serial.print(batChargeCurrentI);Serial.print(" ");
    Serial.print("LEFTMOTORCURRENT ");Serial.print(leftMotorCurrentRAW*4);Serial.print(" ");
    Serial.print("RIGHTMOTORCURRENT ");Serial.print(rightMotorCurrentRAW*4);Serial.print(" ");
    Serial.print("BATCURRENT ");Serial.println(batCurrentI*ADC2CURRENT);
  }
}
